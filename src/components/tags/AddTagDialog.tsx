...
export function AddTagDialog({ open, onOpenChange, onAdd, defaultCategory }: AddTagDialogProps) {
  const [name, setName] = useState('');
  const [category, setCategory] = useState<TagCategory>(defaultCategory || 'custom');
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setName('');
    setCategory(defaultCategory || 'custom');
