...
interface ReporteDominicalDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function ReporteDominicalDialog({ open, onOpenChange }: ReporteDominicalDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!fecha || !liderId) {
      toast({
        ...
        description: 'Fecha y líder en cargado son obligatorios.',
        variant: 'destructive',
      });
      return;
    }
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              <DialogTitle>Reporte Dominical</DialogTitle>
              <DialogDescription>
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
          ...
          <div className="flex flex-col gap-2">
            <Label>Nombre de Líder en cargado</Label>
